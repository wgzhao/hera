...
layui.use(['layer', 'laytpl', 'form'], function () {
        ...
        if (e.data.type !== 1) {
            ...
            if (hostGroups == null) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        //alert("developCenter.js 134行 data : "+ data)
                    }
                });
            }
            ...
            layer.open({
                ...
                yes: function (index, layero) {
                    ...
                    //       alert("parameter = parent=" + id + "&type=" + "2" + "&name=" + name + "$('#hostGroupId').val()" + $('#hostGroupId').val());
                    $.ajax({
                        url: base_url + "/developCenter/addFile",
                        //    url: base_url + "/editUploadFile/addFile",
                        type: "get",
                        async: false,
    ...
    //  $("#addHiveFile").bind('click', {isParent: false, type: 2}, alert("hive-hive-hive"));
    ...
    $("#execute").click(function () {
        ...
        let fileId = $("#tabContainer").data("tabs").getCurrentTabId();
        //   alert("fileId.val: " + fileId)
        let fileScript = codeMirror.getValue();
        //    alert("fileScript: " + fileScript);
        let parameter = {
            id: fileId,
            content: fileScript
        };
        ...
        //    alert("parameter: "+parameter.content+"_____"+parameter.id)
        let sc11 = $('#fileScript [name="editor"]').val
        //    alert("sc11: "+sc11)
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function (res) {
                //      alert(res.date.id+"__"+res.data.content+"___"+res.date.text+"___"+res.data().data)
                if (res.success === true) {
    ...
    $("#executeSelector").click(function () {
        let fileId = $("#tabContainer").data("tabs").getCurrentTabId();
        //   alert(" $(\"#executeSelector\").click(function () -- fileId :" + fileId);
        ...
        //    alert("parameter : " + parameter.id + "____" + parameter.content + "____" + parameter.valueOf());
        let result = null;
        let url = base_url + "/developCenter/debugSelectCode";
        //  let url = base_url + "/developCenter/debugSelectCodeSelf";
            ...
            success: function (data) {
                if (data.success === true) {
                    ...
                    /*  alert("data : " + data);
                     ...
                     alert("msg" + data.msg);
                     alert("directory" + data.directory);
                     alert("jobId" + data.jobId);
                     alert("name" + data.name);
                     alert("runType" + data.runType);
    ...
    $(document).ready(function () {
        ...
        codeMirror.on('change', function () {
            ...
            saveTimer = setTimeout(function () {
                ...
                let url = base_url + "/developCenter/saveScript";
                //      let url = base_url + "/editUploadFile/saveScript";
