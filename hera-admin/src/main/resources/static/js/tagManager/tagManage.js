layui.use(['table', 'laytpl', 'form', 'laydate'], function () {
    $('#tagPush').addClass('active');
    $('#tagPush').parent().addClass('menu-open');
    $('#tagPush').parent().parent().addClass('menu-open');
    ...
    var TableInit = function () {
        ...
        oTableInit.init = function () {
            ...
            table.bootstrapTable({
                url: base_url + '/tagManageController/getAllTagInfo',
                method: 'get',
                queryParams: params,
                pagination: true,
                cache: false,
...
function initMachine(sqlId, tagId) {
    ...
    $.ajax({
        ...
        url: base_url + '/tagManageController/getOldValue',
        type: 'post',
        data: {
            sqlId: sqlId,
            tagId: tagId
...
$("#newTagButton").click(function () {
    ...
    $.ajax({
        url: base_url + '/tagManageController/checkPermission',
        type: 'post',
...
function checkSqlId() {
    ...
    $.ajax({
        url: base_url + '/tagManageController/checkSqlId',
        type: 'post',
        data: data,
        success: function (data) {
    ...
    if (
        ...
        layer.confirm(str,
            ...
            function (index, layero) {
                ...
                /* $.ajax({
                     url: base_url + "/tagManageController/repalceDimMan",
                     data: {
