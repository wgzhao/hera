...
public class DevelopCenterController extends BaseHeraController {
    ...
    public JsonResponse saveScript(@RequestBody HeraFile heraFile) {
        ...
        //      System.err.println("/developCenter/saveScript.do+++++++++++++++++++++++++");
        //       System.err.print("heraFile : "+heraFile);
        //       System.err.println("/developCenter/saveScript.do+");

        boolean result = heraFileService.updateContent(heraFile) > 0;
        int i = heraFileService.updateContent(heraFile);
...
//        System.err.println("/developCenter/saveScript.do+++++++++++++++++++++++++");
     ...
     * @return
     */
    @RequestMapping(value = "/debugSelectCodeSelf", method = RequestMethod.POST)
    @ResponseBody
    public WebAsyncTask<JsonResponse> debugSelectCodeSelf(@RequestBody HeraFile heraFile) {
        //      System.err.println("/debugSelectCodeSelf++++++++++++++++++++++++++++++++++++++++++++");
        String owner = getOwner();
...
//            System.err.println("name : " + name);
            ...
            //           System.err.println("runType : "+runType);
            history.setRunType(runType);
            ...
            while (it.hasNext()) {
                String key = it.next();
                String val = res.get(key).toString();
                // System.err.println("+++++++++++");
