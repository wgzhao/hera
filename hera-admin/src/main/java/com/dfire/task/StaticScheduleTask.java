...
public class StaticScheduleTask
{
    ...
    public void cancelAndRecovery(String historyId, String jobId, String actionId)
            throws Exception
    {
        final String CANCEL_URL = "http://localhost:" + port + contextPath + "/scheduleCenter/cancelJobForOvertime";
        final String RECOVERY_URL = "http://localhost" + port + contextPath + "/scheduleCenter/manualForOvertime";
        // 先执行取消任务
