...
import com.dfire.common.util.LogHelpUtil;
...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendEmail(String title, String content, String address) {
        ...
        System.out.println("EmailServiceImpl  sendEmail  40 .start .... ");
        ...
        try {
            ...
            MonitorLog.info("发送邮件失败,内容:{}, 联系人:{},异常{}", content, address, LogHelpUtil.getSpecificTrace(e));
        }
