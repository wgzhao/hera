...
public class MasterExecuteJob {
    ...
    public Future<Response> executeJob(final MasterContext context, final MasterWorkHolder holder, ExecuteKind kind, final String id) {
        switch (kind) {
            ...
            case ReRun:
                return executeReRunJob(context, holder, id);
            default:
                return null;
        }
    }
     ...
     * @return Future
     */
    private Future<Response> executeReRunJob(MasterContext context, MasterWorkHolder workHolder, String actionId) {
        ...
        return buildFuture(context, Request.newBuilder()
                ...
                .setBody(ExecuteMessage
                        ...
                        .build().toByteString())
                .build(), workHolder, actionId, TriggerTypeEnum.ReRun, jobId);
    }
            ...
            try {
                ...
                switch (typeEnum) {
                    ...
                    case DEBUG:
                        ...
                        break;
                    case ReRun:
                        holder.getReRunRunning().remove(jobId);
                        break;
                    default:
